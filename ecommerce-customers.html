...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Customers | Nazox - Admin & Dashboard Template</title>
    ...
    <!-- <body data-layout="horizontal" data-topbar="dark"> -->
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="form-check">
                                                                ...
                                                                <label class="form-check-label mb-0" for="customercheck6">&nbsp;</label>
                                                            </div>
                                                        </td>
        ...
        <script src="assets/js/pages/ecommerce-customer-datatables.init.js"></script>
